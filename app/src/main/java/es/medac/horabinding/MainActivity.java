    ...
    public class MainActivity extends AppCompatActivity {
        ...
        private void updateResult() {
            ...
            String originText = getString(R.string.label_origin, fromLabel, signed(fromOffsetHours));
            String destinationText = getString(R.string.label_destination, toLabel, signed(toOffsetHours));
            String diffText = getString(R.string.label_difference, signed(diffHours));
            String originTimeText = getString(R.string.label_time_origin, fromTimeStr);
            String destinationTimeText = getString(R.string.label_time_destination, toTimeStr);

            String result = getString(R.string.label_result,
                    originText, destinationText, diffText, originTimeText, destinationTimeText);
